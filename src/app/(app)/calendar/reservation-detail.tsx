          ...
          {r.customer && (
            <div className="flex justify-between">
              ...
              <span className="flex items-center gap-2">
                ...
                <a href={`tel:${r.customer.phone}`} className="flex items-center gap-1 rounded-md border border-border px-2 py-1 text-[12px] text-ink-caption transition-colors hover:bg-bg">
