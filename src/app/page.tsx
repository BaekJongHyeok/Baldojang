    ...
    <div className="flex flex-col flex-1 items-center justify-center bg-bg font-sans">
      <main className="flex flex-1 w-full max-w-3xl flex-col items-center justify-between py-32 px-16 bg-white sm:items-start">
        ...
        <div className="flex flex-col gap-4 text-base font-medium sm:flex-row">
          <a
            className="flex h-12 w-full items-center justify-center gap-2 rounded-lg bg-primary px-5 text-white transition-colors hover:bg-primary-hover md:w-[158px]"
          ...
          <a
            className="flex h-12 w-full items-center justify-center rounded-lg border border-border px-5 transition-colors hover:bg-bg md:w-[158px]"
